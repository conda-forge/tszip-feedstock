...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tszip-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6723&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tszip-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tszip` can be installed with:

```
conda install tszip
```

It is possible to list all of the versions of `tszip` available on your platform with:
